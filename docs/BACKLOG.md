...
| superposition-phase-diagram ⭐ | features as polytopes; sparsity sweep animation | Anthropic toy model, tiny | synthetic sparse features | seconds–2 min | correlated features / alt activations deform the geometry | [toy-models-of-superposition](https://github.com/anthropics/toy-models-of-superposition) | 1 |
