"""Does the key-side magnitude channel survive 3x longer training (1800 steps)?
...
def make_chart(m, p, headline, path):
    ...
    ax.set_ylabel(f"val bits per character ({p['steps']} steps)")
